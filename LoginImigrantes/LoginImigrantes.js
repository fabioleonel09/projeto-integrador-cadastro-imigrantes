...
import logo from '../assets/logoCadastroImigrante.png'
    ...
    <View style = {styles.container}>
      ...
      <View style = {styles.opcao}>
        ...
        <View styles={styles.opcao}>
          ...
          <TouchableOpacity style={styles.botao1} onPress={()=>navigation.navigate('Search')}>
            <Text style={styles.textoBotao1}>Entrar</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.botao2} onPress={()=>navigation.navigate('Register')}>

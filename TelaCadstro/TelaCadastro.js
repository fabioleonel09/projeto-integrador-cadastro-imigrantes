  ...
  return(
    <View style = {styles.container}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          ...
          <View><Text style={styles.textoCabecalho}>Preencha o cadastro abaixo:</Text></View>
        </TouchableOpacity>
...
textInput1: {fontFamily: 'Roboto', fontWeight: 'bold', fontSize: 16, height: 30, justifyContent: "center", alignItems: "left",width: 300, backgroundColor: '#d3d3d3', borderRadius: 20, marginLeft: 45, marginRight: 45, marginTop: 5},

textInput2: {fontFamily: 'Roboto', fontWeight: 'bold', fontSize: 16, height: 30, justifyContent: "center", alignItems: "left",width: 300, backgroundColor: '#d3d3d3', borderRadius: 20, marginLeft: 45, marginRight: 45, marginTop: 30}
